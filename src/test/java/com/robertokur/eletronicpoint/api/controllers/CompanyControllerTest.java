...
public class CompanyControllerTest {
	...
	private static final String FIND_COMPANY_CNPJ_URL = "/api/company/cnpj/";
	private static final Long ID = Long.valueOf(1);
	private static final String CNPJ = "51463645000100";
	private static final String COMPANY_NAME = "Company test";

	@Test
	@WithMockUser
	public void testFindCompanyCNPJInvalid() throws Exception {
	...
	@Test
	@WithMockUser
	public void testCompanyCnpjValid() throws Exception {
